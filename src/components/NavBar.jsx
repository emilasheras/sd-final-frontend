    ...
    <nav className="bg-zinc-950 border-b border-zinc-800">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        <div className="flex gap-6 items-center">
          ...
          <Link to="/public" className="text-base text-zinc-400 hover:text-zinc-200">Público</Link>
          {isAuthenticated && (
            <Link to="/private" className="text-base text-zinc-400 hover:text-zinc-200">Journal</Link>
          )}
        </div>
