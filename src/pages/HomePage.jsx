    ...
    <div className="max-w-2xl mx-auto py-12 space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-zinc-800 p-5 rounded-lg border border-zinc-700">
          ...
          <p className="text-xs text-zinc-600 mt-3 font-mono">GET /api/private/behaviors</p>
        </div>
        <div className="bg-zinc-800 p-5 rounded-lg border border-zinc-700">
          ...
          <p className="text-xs text-zinc-600 mt-3 font-mono">GET /api/private/activities</p>
        </div>
      </div>
